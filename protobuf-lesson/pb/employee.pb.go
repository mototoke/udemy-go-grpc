...
type Employee struct {
	...
	Occupation  Occupation                  `protobuf:"varint,4,opt,name=occupation,proto3,enum=employee.Occupation" json:"occupation,omitempty"`                                                         // スカラ型と同じように扱える
	PhoneNumber []string                    `protobuf:"bytes,5,rep,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"`                                                              // 0個以上の電話番号
	Project     map[string]*Company_Project `protobuf:"bytes,6,rep,name=project,proto3" json:"project,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // mapにはrepeatedを付けることが出来ない
